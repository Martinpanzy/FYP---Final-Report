...
\begin{figure}[H]
\centering
\subfigure[Real-world shoe placement]{\includegraphics[height=6cm,keepaspectratio]{Implementation/cv/3dadj.png}}
...
\subfigure[The frame relationships in Rviz]{\includegraphics[height=6cm,keepaspectratio]{Implementation/cv/3dpos.png} \label{3dpos}}
...
\begin{figure}[H]
\centering
\subfigure[Real-world shoe placement]{\includegraphics[height=6cm,keepaspectratio]{Implementation/cv/3dposwa.png} \label{xaxis}}
\subfigure[The frame relationships in Rviz]{\includegraphics[height=6cm,keepaspectratio]{Implementation/cv/3dori.png}\label{3dori}}
