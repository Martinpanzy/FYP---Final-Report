...
\begin{figure}[H]
\centering
\subfigure[Move to initial pose]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/put1.png}}
\subfigure[Move to pre\_put]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/put2.png}}
\subfigure[Move to shoe\_hole]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/put3.png}}
...
\subfigure[The frame relationships in Rviz]{\includegraphics[height=6cm,keepaspectratio]{Implementation/cv/pickrviz.png}}
...
Notice that, here, the offset for 3D location is different form that of $Prepur\_pose$ and $Insertion\_pose$. This is because this time the gripper does not perform any roll and pitch rotations from its default orientation. In addition, $-0.1$ is added to yaw rotation by taking into account of the !!!!!!!!!!!!!!!!
...
\begin{figure}[H]
\centering
\subfigure[]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/pull1.png}}
\subfigure[]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/pull2.png}}
\subfigure[]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/pull3.png}}
\subfigure[]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/pull4.png}}
\subfigure[]{\includegraphics[width = 0.19\columnwidth]{Implementation/mp/pull5.png}}
