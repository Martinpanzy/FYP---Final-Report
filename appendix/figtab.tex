...
This appendix presents several examples of photos and results when examining the computer vision techniques introduced in Implementation - Computer Vision Chapter using ASUS Xtion camera. Besides, some specific waypoint settings mentioned in Implementation - Motion Planning Chapter are included as well.
