...
In this project, I address the precise AI planning and control problem of putting shoelaces on a marked shoe using a bimanual robot, ABB YuMi, and an external camera, ASUS Xtion. Starting with one arm holding one end of the shoelace, YuMi can adjust the orientation of the shoe if necessary, then pass the shoelace through the shoe hole. As an extension, YuMi will also plan sequences of trajectories for completing more holes up to finishing the whole shoe.
