...
\begin{abstract}
I would like to firstly express my sincere gratitude to my supervisor Prof Yiannis Demiris, for his helpful advice, constructive feedback, and continuous support throughout my project.
...
Also, I would like to thank my friends around the world, who always brings me happiness and encouragement as well, as the wine we drank, the scenery we saw and the things we went through together.

Finally, I would like to thank my family for their unconditional support since I was born and giving me the opportunity to spend this unforgettable four years at Imperial College.
...
\input{RequirementsCap/requirementscap.tex}
\input{AnalysisDesign/analysisdesign.tex}
\input{Implementation/implement_cv.tex}
\input{Implementation/implement_mp.tex}
\input{TaR/tar.tex}
\input{conclusion/conclusion.tex}
\input{Futurework/future.tex}
\input{UserGuide/userguide.tex}


\bibliographystyle{plainnat}
\bibliography{bibs/sample}
\input{appendix/figtab.tex}
